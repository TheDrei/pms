...
INVENTORY - Semi-Expendable Supplies
@endsection
@section('content')
      ...
      <div class="modal-dialog modal-md" role="document" style="width:1500px; padding-right:1100px; padding-left: 300px;">
          <div class="modal-content custom" style="width:900px;">
            ...
            <div class="modal-body">
              <form id="saveICS" method="POST" action="{{ url('save-ics') }}">
                @csrf
                <div class="card">
                  <div class="card-body">
...
<!-- END MODAL -->
    ...
    <p align="left"><button id="equipmentButton" type="button" style="border-radius:4px;" class="btn btn-primary btn-md" data-toggle="modal" data-target="#largeModal"><i class="fa fa-plus"></i>&nbsp; Add Semi-Expendable Supply</button></p>
    <div class = "card-body">
...
<script type="text/javascript">
  ...
  // PROPERTY NUMBER Add and Remove Script
    ...
    window.editAddComponents = function(id) {
      ...
      if (id != 0) {
        var proctr = 0;
        del_btn = "<a href='#' class='btn btn-danger btn-sm' style='border-radius:100px' onclick='deleteICSComponent("+datajson[0].id+")'><i class='fa fa-close'></i></a>";
        proctr -= 1;
      }
  ...
  function deleteICSComponent(id) {
        Swal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            icon: 'warning',
            ...
            if (result.value) {
                window.location.href = "{{ url('ics/delete-components') }}/" + id;
            }
        })
    }
