...
REPORT - Property Acknowledgement Receipt (PAR)
@endsection
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button style="border-radius:4px;" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
<!-- END PPE DETAILS -->
    ...
    <button style="border-radius:4px;" class='btn btn-primary btn-md' type='button'><i class='menu-icon fa fa-plus'></i> Generate PAR</button> 
    <div uk-dropdown='mode: click'> 
       <ul class='uk-nav uk-dropdown-nav'>
       <li> <a href='#'  data-toggle="modal" data-target="#largeModalDivision"> <div style='font-size:18px; font-weight:normal;'><i class='menu-icon fa fa-briefcase'></i> By Division</div></a> </li>
       <li> <a href='#' data-toggle="modal" data-target="#largeModalStaff"> <div style='font-size:18px; font-weight:normal;'><i class='menu-icon fa fa-user'></i> &nbspBy Staff</div></a> </li>
       <li> <a href='#' > <div style='font-size:18px; font-weight:normal;'><i class='menu-icon fa fa-hashtag'></i> By PAR Number</div></a> </li>
       </ul> 
       </div>
       <br/>
    <br/>
    <div class="card-body">
        <table id="bootstrap-data-table" class="table table-striped table-hover" style="background-color: #FFF;width: 100%; ">
                    ...
                    <tbody>
                     <tr id="toclear" style=""><td colspan="14"><center>Click <strong>Generate PAR</strong> to Generate Report</center></td></tr>
                    </tbody>
                  </table>
    </div>

<!-- GENERATE BY DIVISION MODAL  -->
                <div class="modal fade" id="largeModalDivision" tabindex="-1" role="dialog" aria-labelledby="largeModalDivision" aria-hidden="true">
                    <div class="modal-dialog modal-lg"  role="document" style="width:1950px;">
                        <div class="modal-content" style="width:900px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalDivision">Generate PAR by Division</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
             ...
             <button style="border-radius:4px;" id="generatepardivision" type="button" data-dismiss="modal" class="btn btn-primary">Confirm</button>
...
<!-- END GENERATE BY DIVISION MODAL -->


<!-- GENERATE BY STAFF MODAL  -->
                <div class="modal fade" id="largeModalStaff" tabindex="-1" role="dialog" aria-labelledby="largeModalStaff" aria-hidden="true">
                    <div class="modal-dialog modal-lg"  role="document" style="width:1950px;">
                        <div class="modal-content" style="width:900px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalStaff">Generate PAR by Staff</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            @csrf
                                ...
                                <div class="card-body">
                                  ...
                                  <input type="hidden" name="empcode" id="empcode" value="">
                                    ...
                                    <div class="col-12 col-md-2"><label for="text-input" class=" form-control-label">Division</label></div>
                                    <div class="col-12 col-md-4">
                                        <select name="select_division" id="select_division_filterstaff" data-placeholder="Select a Division" class="form-control" required>
                                            <option value="" disabled selected>----Select Division----</option>
                                        </select>
                                    </div>
                                  </div>
                             <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <select name="propassign_form[]" id="select_staff_filterstaff" data-placeholder="Select a Staff" class="form-control"  onchange="getDivision(this.value)" required>
             ...
             <div class="modal-footer">
             <button style="border-radius:4px;" type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
             <button style="border-radius:4px;" id="generateparstaff" type="button" onclick="generatePARStaff()"  data-dismiss="modal" class="btn btn-primary">Confirm</button>
...
<!-- END GENERATE BY STAFF MODAL -->

<!-- GENERATE BY PAR NUMBER MODAL  -->
                <div class="modal fade" id="largeModalNumber" tabindex="-1" role="dialog" aria-labelledby="largeModalNumber" aria-hidden="true">
                    <div class="modal-dialog modal-lg"  role="document" style="width:1950px;">
                        <div class="modal-content" style="width:900px;">
                            <div class="modal-header">
                                <h5 class="modal-title" id="largeModalNumber">Generate PAR by Staff</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            @csrf
                                ...
                                <div class="card-body">
                                  ...
                                  <input type="hidden" name="empcode" id="empcode" value="">
                                    ...
                                    <div class="row form-group">
                                    <div class="col-12 col-md-2"><label for="text-input" class=" form-control-label">PAR Number</label></div>
                                    <div class="col-12 col-md-4">
                                        <select name="select_division" id="select_par_number" data-placeholder="Select a Division" class="form-control" required>
                                            <option value="" disabled selected>----Select PAR Number----</option>
                                        </select>
                                    </div>
                                  </div>
                              </div>
             ...
             <div class="modal-footer">
             <button style="border-radius:4px;" type="button" class="btn btn-secondary close" data-dismiss="modal">Cancel</button>
             <button style="border-radius:4px;" id="generateparstaff" type="button" onclick="generatePARStaff()" class="btn btn-primary">Confirm</button>
...
<!-- END GENERATE BY PAR NUMBER MODAL -->
        ...
        $(document).ready(function() {
         ...
         $('#transfer_propassign_form').select2({
          ...
          $('#select_division').select2({
           ...
           $('#select_division_filterstaff').select2({
                 dropdownParent: "#largeModalStaff",
                 closeOnSelect: true,
                 width: '100%',

                    });

           $('#select_staff_filterstaff').select2({
                 dropdownParent: "#largeModalStaff",
                 closeOnSelect: true,
                 width: '100%',
         ...
         $('#transfer_select_division').select2({
           ...
           //FILTER DIVISION ON ISSUED TO DROP-DOWN
             ...
             //FILTER DIVISION ON ISSUED TO DROP-DOWN
              $("#select_division_filterstaff").on('change', function() {
              $.getJSON( "{{ url('get/division') }}/"+this.value, function( datajson ) {
                      $("#select_staff_filterstaff").empty();
                      jQuery.each(datajson,function(i,obj){
                            $("#select_staff_filterstaff").append("<option value=''>Select a Staff</option>");
                            $("#select_staff_filterstaff").append("<option value='"+obj.username+"'>"+obj.fullname+"</option>");
                  }); 
               ...
               //FILTER DIVISION ON ISSUED TO DROP-DOWN
                  ...
                  //FETCH ALL PAR NUMBERS TO SELECT
                  $.getJSON( "{{ url('json/parnumber/all') }}", function( datajson ) 
                  {
                      jQuery.each(datajson,function(i,obj){
                            $("#select_par_number").append("<option value='"+obj.par_number+"'>"+obj.par_number+"</option>");
                  }); 
                  }); 
                  //END FETCH
           ...
           $('.hidden_component').css('display', 'none');
            ...
            $.getJSON( "{{ url('json/division/all') }}", function( datajson ) {
                      jQuery.each(datajson,function(i,obj){
                            ...
                            $("#select_division_filterstaff").append("<option value='"+obj.division_acro+"'>"+obj.division_acro+"</option>");
...
//GENERATE BY DIVISION
      $(document).on("click", "#generatepardivision", function(){
      ...
      $("#largeModalDivision .close").click();
       ...
       var t = $('#bootstrap-data-table').DataTable({
            ...
            "ajax" : {
                "type" : "GET",
                "url" : "{{ url('get/get_itemspardivision/')}}"+"/"+select_division
            },
            "columns" : [
                { "data" : "id"},
                { "data" : "division"},
...
//END GENERATE BY DIVISION

//GENERATE BY STAFF
      $(document).on("click", "#generateparstaff", function(){

      $("#largeModalStaff .close").click();
...
//END GENERATE BY STAFF  


//GENERATE BY PAR NUMBER
      $(document).on("click", "#generateparnumber", function(){

      $("#largeModalNumber .close").click();
        
         //DATA TABLE DISPLAY 
       var par_number = $("#select_par_number").val();  
       // var propassign_formvar = $("#select_staff").val();
       ...
       var t = $('#bootstrap-data-table').DataTable({
            ...
            "ajax" : {
                "type" : "GET",
                "url" : "{{ url('get/get_itemsparnumber/')}}"+"/"+par_number
            },
            "columns" : [
                { "data" : "id"},
                { "data" : "division"},
...
$("#transferEquipment").modal("toggle");
 ...
 function acceptEquipment(id)
     ...
     {
      window.open("{{ url('pdf/par') }}/"+set_id);
     }
    </script>
