...
<table id="bootstrap-data-table" class="table" style="background-color: #FFF;width: 100%; ">
  ...
  <tbody>
    <tr id="toclear" style="">
      <td colspan="14">
        <center>Click <strong>Generate Property Card</strong> to Generate Report</center>
      </td>
    </tr>
  </tbody>
</table>
        ...
        <form id="saveICS" method="POST" action="{{ url('save-ics2') }}">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row form-group">
                <div class="col-12 col-md-2"><label for="text-input" class=" form-control-label">Fund Cluster</label></div>
                <div class="col-12 col-md-4">
                  <select name="select_division" id="select_division" data-placeholder="Select a Fund Cluster" class="form-control" required>
