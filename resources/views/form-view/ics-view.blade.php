                ...
                <div class="par-header">
                    ...
                    <div class="header-row flex-container">
                        <div class="flex-grow-1">
                                ...
                                <div style="width:300px;">
                                <select name="ics_type" id="ics_type" data-placeholder="Choose an ICS Type" class="form-control" required>
                    ...
                    <div class="header-row flex-container">
                        <div class="flex-grow-1">
                                ...
                                <div style="width:300px;">
                                <input type="date" name="date_ics" id="date_ics" class="form-control" required>
                                </div>
                                <input type="checkbox" id="date_ics_check" name="date_ics_check" value="No Date of ICS">
                   ...
                   <div class="solid-borders"><strong>&nbspTotal Cost: ₱<span id="total_cost"></span></strong></div>
                    ...
                    <div class="signatories flex-container">
                        ...
                        <div class="issued-by-information border-black-1 signatory-container">
                            ...
                            <select name="select_staff" id="select_staff" data-placeholder="Select a Staff" class="form-control" onchange="getDivision(this.value)" required>
