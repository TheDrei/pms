...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#issued-by-date').html(today);
        $('#received-by-date').html(today);
        ...
        $("#propassign_form_1").on('change', function() {
            $.getJSON("{{ url('get/position') }}/" + this.value, function(datajson) {
                jQuery.each(datajson, function(i, obj) {
                $("#employee_position").html(obj.position_desc);
                $("#employee_position_get").val(obj.position_desc);
        ...
        window.addComponents = function(id) {
            ...
            $("#property-table tr:last").after("<tr class='solid-borders'><td class='solid-borders'><input style='font-size:12px; width:200px;' type='text' class='form-control' name='inventory_item_number[]' value=''></td><td class='solid-borders'><select onchange='getClass(this.value)' style='font-size:12px; width:300px;' name='equip_subcat[]' id='equip_subcat_" + proctr + "' class='form-control prop_assign_ctr'><option value='' selected>Select a Sub-Category</option></select></td><td class='solid-borders'><input style='font-size:12px; width:200px;' type='text' class='form-control' name='equipment_category[]' id='equipment_category_" + proctr + "'></td><td class='solid-borders'><textarea style='font-size:12px; width:200px;' type='text' class='form-control prop_component_ctr' name='prop_component[]' id='prop_component_" + proctr + "'></textarea></td><td class='solid-borders'><input style='font-size:12px; width:50px;' type='number' class='form-control' value='1' name='component_quantity[]' id='component_quantity_" + proctr + "'></td><td class='solid-borders'><input style='font-size:12px; width:50px;' type='text' class='form-control' name='equip_subprop_num[]' value='" + proctr + "'></td><td class='solid-borders'><input style='font-size:12px; width:200px;' type='text' class='form-control' name='equip_serial_num[]' id='equip_serial_num_" + proctr + "' value=''></td><td class='solid-borders'><input style='font-size:12px; width:200px;' type='number' class='form-control' name='estimated_useful_life[]' id='estimated_useful_life_" + proctr + "' value=''></td><td class='solid-borders'><input style='font-size:12px; width:200px;' step='any' type='number' class='form-control unit-cost' name='equip_unit_cost[]' id='equip_unit_cost_" + proctr + "' value='' required></td><td class='solid-borders'>" + del_btn + "</td></tr>");
